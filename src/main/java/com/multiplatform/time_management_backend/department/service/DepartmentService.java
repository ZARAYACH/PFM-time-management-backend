...
public class DepartmentService {
    ...
    public Department create(DepartmentDto departmentDto) throws NotFoundException {
        Department department = departmentRoomSharedService.validateDepartmentDtoAndCreate(departmentDto);
        return departmentRepository.save(department);
    }

    public Department modify(Department department, DepartmentDto departmentDto) throws NotFoundException {
